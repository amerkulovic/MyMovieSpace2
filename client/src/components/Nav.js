...
const Nav = (props) => {
  ...
  return (
    <div className="bg-gradient-to-r from-red-900 via-red-700 to-red-900 flex items-center max-lg:justify-between justify-center py-4 shadow-lg shadow-black/30">
