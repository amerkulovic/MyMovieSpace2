...
const HamburgerMenu = (props) => {
  return (
    <div>
      <div className={`fixed z-10 left-0 top-0 h-full w-full pt-[100px] pl-10 bg-red-800 transform ${props.isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out`}>
